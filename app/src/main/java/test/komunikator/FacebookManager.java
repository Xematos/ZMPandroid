...
import test.komunikator.network.ApiService;
...
public class FacebookManager {
    ...
    private Call<test.komunikator.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<test.komunikator.entities.AccessToken>() {
            @Override
            public void onResponse(Call<test.komunikator.entities.AccessToken> call, Response<test.komunikator.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<test.komunikator.entities.AccessToken> call, Throwable t) {
